...
class WaveformWidget(QWidget):
    ...
    def _draw_wave(self, painter: QPainter, w: int, h: int) -> None:
        ...
        # 波形颜色
        painter.setPen(QPen(QColor(107, 138, 255, 200), 2, Qt.PenStyle.SolidLine))
        ...
        # 中心线
        painter.setPen(QPen(QColor(107, 138, 255, 40), 1, Qt.PenStyle.SolidLine))
...
class StatusIndicator(QWidget):
    ...
    def set_status(self, status: str, text: str = "") -> None:
        ...
        if text:
            ...
            self._status_text = self._get_default_text(status)
    ...
    def _get_default_text(self, status: str) -> str:
        texts = {
            "idle": "点击麦克风开始录音",
            "recording": "正在录音...",
            "processing": "正在识别...",
    ...
    def paintEvent(self, event) -> None:  # type: ignore[override]
        ...
        colors = {
            ...
            "recording": QColor(255, 59, 48, 220),
            "processing": QColor(255, 149, 0, 200),
            "success": QColor(52, 199, 89, 200),
            "error": QColor(255, 59, 48, 200),
        }
        color = colors.get(self._status, QColor(154, 160, 168, 180))
        ...
        painter.setPen(Qt.PenStyle.NoPen)
        painter.setBrush(QBrush(color))
        painter.drawEllipse(12, center_y - 5, 10, 10)
